...
<div class="slider-wrapper theme-default">
    ...
    <div id="slider" class="nivoSlider">
        <a href="shop.html"><img width="899" height="409" src="{{asset('frontEnd/img/slider/a.jpg')}}" data-thumb="{{asset('frontEnd/img/slider/1.jpg')}}" alt="" title="#htmlcaption" /></a>
        <a href="shop.html"><img width="899" height="409" src="{{asset('frontEnd/img/slider/b.jpg')}}" data-thumb="{{asset('frontEnd/img/slider/2.jpg')}}" alt="" title="#htmlcaption2" /></a>
        <a href="shop.html"><img width="899" height="409" src="{{asset('frontEnd/img/slider/c.jpg')}}" data-thumb="{{asset('frontEnd/img/slider/2.jpg')}}" alt="" title="#htmlcaption2" /></a>
        <a href="shop.html"><img width="899" height="409" src="{{asset('frontEnd/img/slider/d.jpg')}}" data-thumb="{{asset('frontEnd/img/slider/2.jpg')}}" alt="" title="#htmlcaption2" /></a>
    </div>
    <!-- Slider Background  Image Start-->
</div>
@endsection
...
<div class="image-banner pb-50 off-white-bg">
    <div class="container">
        <div class="col-img">
            <a href="#"><img width="1169" height="60" src="{{asset('frontEnd/img/banner/do1.png')}}" alt="image banner"></a>
        </div>
    </div>
    <!-- Container End -->
</div>
            ...
            <div class="single-product">
                ...
                <div class="pro-content">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="{{asset('frontEnd/img/products/30.jpg')}}" alt="single-product">
                                <img class="secondary-img" src="{{asset('frontEnd/img/products/31.jpg')}}" alt="single-product">
                            </a>
                            <div class="countdown" data-countdown="2020/03/01"></div>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="{{asset('frontEnd/img/products/10.jpg')}}" alt="single-product">
                                <img class="secondary-img" src="{{asset('frontEnd/img/products/11.jpg')}}" alt="single-product">
                            </a>
                            <div class="countdown" data-countdown="2020/03/01"></div>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
        ...
        <div class="big-banner mt-100 pb-85 mt-sm-60 pb-sm-45">
            <div class="container banner-2">
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-1.jpg')}}" alt="banner 3"></a>
                    </div>
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-2.jpg')}}" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-3.jpg')}}" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-4.jpg')}}" alt="banner 3"></a>
                    </div>
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-5.jpg')}}" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-6.jpg')}}" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-7.jpg')}}" alt="banner 3"></a>
                    </div>
                    <div class="col-img">

                        <a href="#"><img src="{{asset('frontEnd/img/banner/banner3-8.jpg')}}" alt="banner 3"></a>
                    </div>
                </div>
            </div>
            <!-- Container End -->
        ...
        <div class="main-brand-banner pt-95 pb-100 pt-sm-55 pb-sm-60">
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-3">
                        <div class="col-img">
                            <img src="{{asset('frontEnd/img/banner/h1-band1.jpg')}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- Brand Banner Start -->
                        <div class="brand-banner owl-carousel">
                            <div class="single-brand">
                                <a href="#"><img class="img" src="{{asset('frontEnd/img/brand/1.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/2.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/3.jpg')}}" alt="brand-image"></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img class="img" src="{{asset('frontEnd/img/brand/1.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/2.jpg')}}" alt="brand-image"></a>
                            ...
                            <div class="single-brand">
                                <a href="#"><img src="{{asset('frontEnd/img/brand/1.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/2.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/3.jpg')}}" alt="brand-image"></a>
                            ...
                            <div class="single-brand">
                                <a href="#"><img src="{{asset('frontEnd/img/brand/2.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/3.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/4.jpg')}}" alt="brand-image"></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{asset('frontEnd/img/brand/2.jpg')}}" alt="brand-image"></a>
                                <a href="#"><img src="{{asset('frontEnd/img/brand/3.jpg')}}" alt="brand-image"></a>
                    ...
                    <div class="col-lg-3">
                        <div class="col-img">
                            <img src="{{asset('frontEnd/img/banner/h1-band2.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
